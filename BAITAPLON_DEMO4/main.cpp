...
int main(int argc, char *argv[])
{
    ...
    SDL_Texture* continuegame = graphics.loadTexture("img\\CONTINUE.png");
    ...
    while(!quit){
        ...
        case GAME_LOOP:
            {
               ...
               if (diem!=0 && diem%2==0 && !screenscrollIncreased) {
                ...
                else if(diem>9&&diem<=13&& !checkHD)
                {
                    yhuongdan3-=4;
                    graphics.renderTexturehuongdan(huongdanchimxanh,xhuongdan3,yhuongdan3);
                ...
                else if(diem>13 && diem <=16&& !checkHD)
                {
                    yhuongdan4-=4;
                    graphics.renderTexturehuongdan(huongdanchimbeo,xhuongdan4,yhuongdan4);
                ...
                //string luotchem_text = "Luot chem " + luotchem_number;
        ...
        /*case GAME_PAUSE:
        {
            ...
            SDL_GetMouseState(&a,&b);
            while(SDL_PollEvent(&e)){
                    if(e.type==SDL_MOUSEBUTTONDOWN && (a>SCREEN_WIDTH/2 + SCREEN_WIDTH/6&&a<SCREEN_WIDTH/2 + SCREEN_WIDTH/6+300&&b>20&&b<67))
                    {
                        graphics.play(gPress);
                        game_state=GAME_LOOP;
                    }
            ...
            graphics.renderTexture(continuegame,SCREEN_WIDTH/2 + SCREEN_WIDTH/6, 20);
